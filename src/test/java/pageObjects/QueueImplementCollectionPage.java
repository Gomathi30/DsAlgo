...
public class QueueImplementCollectionPage extends BaseClass{

	public QueueImplementCollectionPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}
	//Webelements in Queue implementation using list page
